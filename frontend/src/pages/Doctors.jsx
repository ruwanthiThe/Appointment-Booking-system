        ...
        <div className='w-full grid gap-4 pt-5 gap-y-6 px-3 sm:px-0' style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))' }}>
          {
            ...
            <div onClick={()=>navigate(`/appoinment/${item._id}`)} key={index} className='border border-blue-200 rounded-xl overflow-hidden cursor-pointer hover:-translate-y-2 transition-all duration-500 bg-white shadow-md flex flex-col w-full max-w-[260px] min-h-[370px] mx-auto'> 
