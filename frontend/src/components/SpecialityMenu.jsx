...
const SpecialityMenu = () => {
  ...
  <h1 className='text-3xl font-bold mb-2 text-blue-600'>Find by Speciality</h1>
  <p className='sm:w-1/3 text-center text-md'>Simply browse through our extensive list of trusted doctors,Schedule your appoinment hassle-free.</p>
